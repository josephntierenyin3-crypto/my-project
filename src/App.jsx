...
function App() {
    ...
    return (
      <div className="planner-app planner-loading">
        <div className="loading-card" aria-label="Loading">
          ...
          <div className="skeleton sk-row short" />
          <div className="skeleton sk-row" />
        </div>
      </div>
    )
  ...
  if (loading) {
    return (
      <div className="planner-app planner-loading">
        <div className="loading-card" aria-label="Loading planner">
          <div className="loading-top">
            <div className="spinner" aria-hidden />
            <div>
              <div className="skeleton sk-title" />
  ...
  return (
    <div className="planner-app">
      <div className="bg-layer" aria-hidden>
        <ParticleBackground density={75} linkDistance={135} opacity={0.18} />
      </div>
      <aside className="planner-sidebar" aria-label="Main navigation">
        ...
        <div className="sidebar-cta">
          ...
          <details className="sidebar-menu">
            <summary className="sidebar-menu-trigger" aria-label="Open menu">
              Menu
            </summary>
            <div className="sidebar-menu-pop">
              <div className="sidebar-menu-header">Today</div>
              <div className="sidebar-menu-stats">
                <div className="menu-stat">
                  <span className="k">Meetings</span>
                  <span className="v">{meetingsToday}</span>
                </div>
                <div className="menu-stat">
              ...
              <div className="sidebar-menu-header">Quick actions</div>
              <button
                type="button"
                ...
                onClick={() => {
                  setActiveTab('tasks')
                  setTimeout(() => {
                    const el = document.querySelector('.form-inline .input-flex')
                    if (el) el.focus()
                  }, 0)
                }}
              >
